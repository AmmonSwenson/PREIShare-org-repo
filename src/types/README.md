...
Do **not** add `investor-listing.ts` (or other listing models) in this scaffold step. Later steps own those files. This folder is tracked now so Git keeps the home they will live in.
